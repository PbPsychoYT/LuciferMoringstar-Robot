...
# ---------- 📁 [ | 𝗣𝗠 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            for files in filedetails:
                ...
                buttons = [[
                  InlineKeyboardButton('Join Channel', url='https://t.me/MalluHubTG')
                  ]]                 
...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("Channel", url="https://t.me/MalluHubTG"),
                 InlineKeyboardButton("Group", url="https://t.me/MalluHubGP")
                 ]]
            else:
                buttons = [[
                 InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
